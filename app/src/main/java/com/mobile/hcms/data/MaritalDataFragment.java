...
public class MaritalDataFragment extends Fragment{

    Bundle bundle = null;

    private EmployeeDetailActivity activity;
    public MaritalDataFragment() {
        super();
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //activity.setTitle("Marital Info");
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_marital_data, container, false);
